...
------------------------------------------------------------------------------------------------ */
//try to use for each to pull and iterate through the array of strings to find matches.
//return index of the array if not at index zero put in a new array.
...
------------------------------------------------------------------------------------------------ */
//there might be this exact string of characters

// o ct ober

const matchMonth = (input) => {
  // Solution code here...
  if (input.toString().match(/^[Oo]ct(ober)?$/)) {
    return true
  } else {
    return false
  }
